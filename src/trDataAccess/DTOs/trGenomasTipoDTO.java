...
public class trGenomasTipoDTO {
    ...
    public trGenomasTipoDTO() {}

    public trGenomasTipoDTO(Integer trIdCatalogo, Integer trIdCatalogoTipo, String trNombre, String trDescripcion,
