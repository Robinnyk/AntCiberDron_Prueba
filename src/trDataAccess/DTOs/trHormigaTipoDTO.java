...
public class trHormigaTipoDTO {
   ...
   private Integer trIdCatalogo;
    ...
    public trHormigaTipoDTO() {}

    public trHormigaTipoDTO(Integer trIdCatalogo, Integer trIdCatalogoTipo, String trNombre, String trDescripcion,
